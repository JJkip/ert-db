					...
					<div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <h4 class="title">Editing Candidate Details</h4>
						      </div>
						      <div class="modal-body">
						        <form>
						          ...
						          <div class="form-group">
						            ...
						            <input type="text" class="form-control" id="recipient-name" value="PRESIDENT">
						          </div>
						          <div class="form-group">
						            <label for="recipient-name" class="control-label">Party:</label>
						            <input type="text" class="form-control" id="recipient-name" value="AA">
						          </div>
						          <div class="form-group">
						          ...
						          <div class="form-group">
						            ...
						            <input type="text" class="form-control" id="recipient-name" value="BED">
						          </div>
						        </form>
						      </div>
